...
import { countAllTransactionPeriods, getDateFromReceivedString, getTimeAgo } from '../utils/utils';
            ...
            <div className="flex items-center space-x-4">
              ...
              <div
                className={
                  ...
                  (getDateFromReceivedString(transactions[0]?.receivedAt).getTime() < new Date().getTime() - 86400 * 7 * 1000
